...
class Header extends Component {
    ...
    UserSpace() {
        if (this.state.account)
            return (
                <>
                    <a className="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <img src='/black-logo.svg' className="user-img" alt="user avatar"></img>
                        <div className="user-info ps-3">
                            <p className="user-name mb-0">{resumedAddress(this.state.account)}</p>
                            <p className="designattion mb-0"><strong>{`${pMinify(this.state.bnb_balance, 4)}`}</strong></p>
                        </div>
                    </a>
                    <ul className="dropdown-menu dropdown-menu-end">
                        <li><a className="dropdown-item" onClick={() => this.disconnect()}><i
                            className='bx bx-log-out-circle'></i><span>Log Out</span></a>
                        </li>
                    </ul>
                </>
            )
            ...
            return (
                <button onClick={() => this.connect()} type="button" className="btn btn-outline-dark  px-3 radius-30">Connect</button>
            )
        }
    }
            ...
            <>
                ...
                <div className="sidebar-wrapper" data-simplebar="true">
                    <div className="sidebar-header">
                        <div>
                            <img src="black-logo.svg" className="logo-icon" alt="logo icon"></img>
                        </div>
                        <div>
                            <p className="logo-text"> <span className="badge bg-primary bg-iuser-youtube"></span></p>
                        </div>
                    ...
                    <ul className="metismenu" id="menu">
                        ...
                        <li>
                            <Link className="text-stats-facebook" to="/facebook">
                                <div className="parent-icon"><i className="bx bxl-linkedin"></i>
                                </div>
                        ...
                        <li className="menu-label"><strong>Another Social Network</strong></li>
                        <li>
